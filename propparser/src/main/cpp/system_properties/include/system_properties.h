...
#ifndef ANDROID10DEVICEFINGERPRINT_SYSTEM_PROPERTIES_H
#define ANDROID10DEVICEFINGERPRINT_SYSTEM_PROPERTIES_H
#include <stdint.h>
#include <sys/param.h>
...
#endif //ANDROID10DEVICEFINGERPRINT_SYSTEM_PROPERTIES_H
